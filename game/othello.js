window.addEventListener("DOMContentLoaded", () => {
  ...
  function finishGame(){
    ...
    if(p > w){
      ...
      resultPanel.style.color = "#ff69b4";
      resultPanel.style.fontSize = "2rem";
      resultPanel.style.fontWeight = "bold";
      resultPanel.style.textShadow = "0 0 10px #ffb6c1, 0 0 20px #ff69b4";
    } else if(p < w){
      msg = defeatMessages[Math.floor(Math.random() * defeatMessages.length)];
      resultPanel.style.color = "#999";
      resultPanel.style.fontSize = "1.8rem";
      resultPanel.style.fontWeight = "bold";
      resultPanel.style.textShadow = "0 0 5px #bbb, 0 0 10px #888";
    } else {
      msg = drawMessages[Math.floor(Math.random() * drawMessages.length)];
      resultPanel.style.color = "#6a5acd";
      resultPanel.style.fontSize = "1.8rem";
      resultPanel.style.fontWeight = "bold";
      resultPanel.style.textShadow = "0 0 5px #c0c0ff, 0 0 10px #aaa";
    }
