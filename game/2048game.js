document.addEventListener("DOMContentLoaded", () => {
  ...
  // スマホ用のリスタートボタンも対応
  const restartMainButton = document.getElementById("restart-main");
  if (restartMainButton) {
    restartMainButton.addEventListener("click", resetGame);
  }
  ...
  if (btnDown) btnDown.addEventListener("click", () => move(3));
  if (btnLeft) btnLeft.addEventListener("click", () => move(0));
  if (btnRight) btnRight.addEventListener("click", () => move(2));
