...
app.get("/game/fortune", requireLogin, (req, res) => {
  res.sendFile(path.join(__dirname, "game", "game.html"));
});
app.get("/diagnosis/diagnosis.html", requireLogin, (req, res) => {
  res.sendFile(path.join(__dirname, "diagnosis", "diagnosis.html"));
});

// ====================== お問い合わせ ======================

// CSRF トークン生成関数（他人PCから送信する用）
...
app.get("/inquiry", requireLogin, (req, res) => {
...
app.post("/inquiry", requireLogin, (req, res) => {
